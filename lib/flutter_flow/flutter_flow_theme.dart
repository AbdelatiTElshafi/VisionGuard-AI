...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFFF57C00);
  ...
  late Color hint = const Color(0xFFBDBDBD);
  late Color divider = const Color(0xFFEEEEEE);
  late Color outline = const Color(0xFFEEEEEE);
}
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color tertiary = const Color(0xFF424242);
  ...
  late Color hint = const Color(0xFF424242);
  late Color divider = const Color(0xFF2C2C2C);
  late Color outline = const Color(0xFF2C2C2C);
}
